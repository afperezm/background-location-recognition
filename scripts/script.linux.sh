...
# Pre vs Post
PerfEval -perf list_gt.txt list_db_ld.txt ranked_candidates.txt occurrence_matrix_pregv.txt voted_landmarks_pregv.txt
...
PerfEval -perf list_gt_featsel.txt list_db_ld.txt ranked_candidates_featsel.txt occurrence_matrix_featsel.txt voted_landmarks_featsel.txt
